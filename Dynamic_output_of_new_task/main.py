...
def main():
    ...
    #
    # uavs = [
    #     UAV(id=1, position=(50, 0), remaining_energy=600, working=True, speed=5, fuel_consumption=1),
    #     UAV(id=2, position=(50, 0), remaining_energy=600, working=True, speed=5, fuel_consumption=1),
    #     UAV(id=3, position=(50, 0), remaining_energy=2000, working=True, speed=5, fuel_consumption=1),
    #     UAV(id=4, position=(50, 0), remaining_energy=600, working=True, speed=5, fuel_consumption=1),
    #     UAV(id=5, position=(50, 0), remaining_energy=600, working=True, speed=5, fuel_consumption=1)
    # ]
